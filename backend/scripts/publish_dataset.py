...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Publish dataset into immutable clean grid + optional agent workspaces.",
    )
