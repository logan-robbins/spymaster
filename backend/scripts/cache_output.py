...
Usage example:
    uv run scripts/cache_output.py \
...
from src.qmachina.config import RuntimeConfig, resolve_config
from src.models.vacuum_pressure.stream_pipeline import stream_events

logger = logging.getLogger("cache_output")
...
def main() -> None:
    ...
    logging.getLogger("src.models.vacuum_pressure.event_engine").setLevel(logging.ERROR)
