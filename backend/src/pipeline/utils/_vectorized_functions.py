"""
Vectorized Functions - Internal Module

Core vectorized operations for pipeline stages. All functions use
NumPy/pandas vectorization optimized for Apple M4 Silicon with 128GB RAM.

This is an internal module. Import from src.pipeline.utils.vectorized_ops instead.
