...
class UnifiedStreamCache:
    """Cache for unified streaming: futures snap + velocity + options."""
    snap: pd.DataFrame
...
class VelocityStreamService:
    ...
    def load_cache(self, symbol: str, dt: str) -> UnifiedStreamCache:
        """Load unified cache with futures snap, futures velocity, and options velocity."""
    ...
    def iter_batches(
        ...
        """Iterate over time windows yielding unified snap + velocity + options batches."""
