...
def build_grid_update_payload(grid: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "state_model_name": grid["state_model_name"],
        "state_model_score": grid["state_model_score"],
        "state_model_ready": grid["state_model_ready"],
        "state_model_sample_count": grid["state_model_sample_count"],
        "state_model_base": grid["state_model_base"],
        "state_model_d1": grid["state_model_d1"],
        "state_model_d2": grid["state_model_d2"],
        "state_model_d3": grid["state_model_d3"],
        "state_model_z1": grid["state_model_z1"],
        "state_model_z2": grid["state_model_z2"],
        "state_model_z3": grid["state_model_z3"],
        "state_model_bull_intensity": grid["state_model_bull_intensity"],
        "state_model_bear_intensity": grid["state_model_bear_intensity"],
        "state_model_mixed_intensity": grid["state_model_mixed_intensity"],
        "state_model_dominant_state5_code": grid["state_model_dominant_state5_code"],
    }
