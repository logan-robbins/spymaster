"""Shared time-boundary and tick-resolution utilities for stream pipelines."""
...
def resolve_tick_int(config: RuntimeConfig) -> int:
    """Resolve integer tick increment used by the physics engine."""
