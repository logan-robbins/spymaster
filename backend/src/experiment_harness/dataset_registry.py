...
class DatasetPaths:
    ...
    Attributes:
        ...
        grid_clean_parquet: Path to the silver grid_clean.parquet file.
        gold_grid_parquet: Path to the gold_grid.parquet file. May not exist;
            call .exists() before reading. Generated by `generate-gold` CLI command.
        dataset_id: The string identifier for this dataset.
    """

    bins_parquet: Path
    grid_clean_parquet: Path
    gold_grid_parquet: Path
    dataset_id: str
    ...
    def resolve(self, dataset_id: str) -> DatasetPaths:
        ...
        if bins_path.exists():
            ...
            return DatasetPaths(
                ...
                gold_grid_parquet=immutable_dir / "gold_grid.parquet",
        ...
        if bins_path.exists():
            ...
            return DatasetPaths(
                bins_parquet=bins_path,
                grid_clean_parquet=grid_path,
                gold_grid_parquet=generated_dir / "gold_grid.parquet",
                dataset_id=dataset_id,
            )
