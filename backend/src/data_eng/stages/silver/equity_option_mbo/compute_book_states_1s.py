...
class SilverComputeEquityOptionBookStates1s(Stage):
    def __init__(self) -> None:
        super().__init__(
            ...
            io=StageIO(
                inputs=["bronze.equity_option_mbo.cmbp_1", "silver.equity_mbo.book_snapshot_1s"],
                output=[
    ...
    def run(self, cfg: AppConfig, repo_root: Path, symbol: str, dt: str) -> None:
        out_snap_key = "silver.equity_option_mbo.book_snapshot_1s"
        out_flow_key = "silver.equity_option_mbo.depth_and_flow_1s"
        ...
        cmbp_key = "bronze.equity_option_mbo.cmbp_1"
