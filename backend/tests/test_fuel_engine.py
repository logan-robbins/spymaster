...
class TestBasicGammaComputation:
    ...
    def test_amplify_effect_dealers_short_gamma(self, fuel_engine, market_state):
        ...
        Scenario: Customers bought calls at strike 6850
        → Dealers sold calls
        ...
        market_state.option_flows[(6850.0, 'C', '2025-12-16')] = OptionFlowAggregate(
            strike=6850.0,
            right='C',
            exp_date='2025-12-16',
        ...
        # Compute fuel state near level 6850
    ...
    def test_dampen_effect_dealers_long_gamma(self, fuel_engine, market_state):
        ...
        Scenario: Customers sold calls at strike 6850
...
class TestStrikeRangeAggregation:
    ...
    def test_aggregate_multiple_strikes_near_level(self, fuel_engine, market_state):
        ...
        """
        # Setup multiple strikes near level 6850
        market_state.option_flows[(6849.0, 'C', '2025-12-16')] = OptionFlowAggregate(
            strike=6849.0,
            right='C',
            exp_date='2025-12-16',
        ...
        market_state.option_flows[(6851.0, 'P', '2025-12-16')] = OptionFlowAggregate(
            strike=6851.0,
            right='P',
            exp_date='2025-12-16',
    ...
    def test_exclude_strikes_outside_range(self, fuel_engine, market_state):
        ...
        market_state.option_flows[(6855.0, 'C', '2025-12-16')] = OptionFlowAggregate(
            strike=6855.0,  # Outside range (6850 ± 2)
            right='C',
            exp_date='2025-12-16',
...
class TestWallIdentification:
    ...
    def test_call_wall_identification(self, fuel_engine, market_state):
        ...
        market_state.option_flows[(6851.0, 'C', '2025-12-16')] = OptionFlowAggregate(
            strike=6851.0,
            right='C',
            exp_date='2025-12-16',
        ...
        market_state.option_flows[(6852.0, 'C', '2025-12-16')] = OptionFlowAggregate(
            strike=6852.0,
            right='C',
            exp_date='2025-12-16',
        ...
        market_state.option_flows[(6853.0, 'C', '2025-12-16')] = OptionFlowAggregate(
            strike=6853.0,
            right='C',
            exp_date='2025-12-16',
        ...
        # Should identify 6852 as call wall
        assert metrics.call_wall is not None
        assert metrics.call_wall.strike == 6852.0
    ...
    def test_put_wall_identification(self, fuel_engine, market_state):
        ...
        market_state.option_flows[(6849.0, 'P', '2025-12-16')] = OptionFlowAggregate(
            strike=6849.0,
            right='P',
            exp_date='2025-12-16',
        ...
        market_state.option_flows[(6848.0, 'P', '2025-12-16')] = OptionFlowAggregate(
            strike=6848.0,
            right='P',
            exp_date='2025-12-16',
        ...
        market_state.option_flows[(6847.0, 'P', '2025-12-16')] = OptionFlowAggregate(
            strike=6847.0,
            right='P',
            exp_date='2025-12-16',
        ...
        # Should identify 6848 as put wall
        assert metrics.put_wall is not None
        assert metrics.put_wall.strike == 6848.0
...
class TestHVLEstimation:
    ...
    def test_hvl_gamma_flip_detection(self, fuel_engine, market_state):
        ...
        # Should detect HVL near 6850
        assert metrics.hvl is not None
        assert 6849.0 <= metrics.hvl <= 6851.0
...
class TestConfidenceScaling:
    ...
    def test_confidence_scales_with_volume(self, fuel_engine, market_state):
        ...
        market_state_low.option_flows[(6850.0, 'C', '2025-12-16')] = OptionFlowAggregate(
            strike=6850.0,
            right='C',
            exp_date='2025-12-16',
            net_gamma_flow=-20000.0,
        ...
        metrics_low = fuel_engine.compute_fuel_state(6850.0, market_state_low, '2025-12-16')
        
        # High volume case
        market_state_high = MarketState()
        market_state_high.option_flows[(6850.0, 'C', '2025-12-16')] = OptionFlowAggregate(
            strike=6850.0,
            right='C',
            exp_date='2025-12-16',
            net_gamma_flow=-20000.0,
        ...
        metrics_high = fuel_engine.compute_fuel_state(6850.0, market_state_high, '2025-12-16')
...
class TestGlobalWallRetrieval:
    ...
    def test_get_all_walls_across_strikes(self, fuel_engine, market_state):
        ...
        # Setup market state with spot price using ES trade
        ...
        # Setup strong call wall at 6860
        market_state.option_flows[(6860.0, 'C', '2025-12-16')] = OptionFlowAggregate(
            strike=6860.0,
            right='C',
            exp_date='2025-12-16',
        ...
        # Setup strong put wall at 6840
        market_state.option_flows[(6840.0, 'P', '2025-12-16')] = OptionFlowAggregate(
            strike=6840.0,
            right='P',
            exp_date='2025-12-16',
        ...
        assert call_wall.strike == 6860.0
        assert put_wall is not None
        assert put_wall.strike == 6840.0
